...
include 'conn.php';
include 'head.php';
include 'teacher-nav.php'; // Update to include teacher navigation
...
if ($role && $role_id) {
    ...
    if ($result && $result->num_rows == 1) {
        ...
        $_SESSION['edit_user'] = $user; // Store teacher details in session for editing
                ...
                <div class="row pt-3">
                    <div class="col-md-6">
                        <div class="container-fluid p-2">
                            <h3><strong>Edit Teacher Credentials</strong></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="container bg-white p-4 rounded-lg">
                    ...
                    ?>
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <button type="submit" class="btn btn-success" name="update" style="width: 100%;">Save</button>
                        </form>
                    <?php } ?>
                </div>
            </div>
