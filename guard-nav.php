...
<nav class="navbar navbar-expand-lg navbar-dark bg-success fixed-top">
    <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center" href="student-index.php">
            ...
            <span class="ml-2"><strong>GuideCo<sup class="small-text">Guard</sup></strong></span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="guard-index.php">Report</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="guard-account.php">My Account</a>
                </li>
                <li class="nav-item">
